...
for yini in year_range:
    ...
    plt.ylabel('DSWR [J/m2]')
    plt.xlabel('Time')

plt.tight_layout()
fig.suptitle("GOTM Downward Short-wave Radiation at BATS (12 hourly)", fontsize=12)
plt.subplots_adjust(top=0.95)

outfile='../figs/plot_surf_dswr_'+str(year_ini)+'-'+str(year_end)+'.png'
