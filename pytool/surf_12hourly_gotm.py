...
data_ma = moving_average(sst,1)
sst = data_ma

data_ma = moving_average(dswr,1)
dswr = data_ma

data_ma = moving_average(airt,1)
airt = data_ma

# apply moving average

ws10 = np.sqrt(np.square(u10)+np.square(v10))
ws10_ma = moving_average(ws10,1)
ws10 = ws10
...
plt.tight_layout()
fig.suptitle("GOTM surface parameters at BATS (12 hourly)", fontsize=12)
plt.subplots_adjust(top=0.95)

outfile='../figs/plot_surf_12hourly_'+str(yini)+'-'+str(yend)+'.png'
