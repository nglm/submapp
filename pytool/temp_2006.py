...
midmon = dates.MonthLocator(bymonthday=15)      
mfmt   = dates.DateFormatter('%b')              # name of month
...
ax.xaxis.set_minor_locator(midmon)
...
plt.savefig('../figs/temp_'+yini+'.png',format='png',dpi=1000)
plt.show()
