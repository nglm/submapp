...
plt.pcolormesh(date_axis_range, depth, data_range, vmin=0.0, vmax=5.0, cmap='viridis')
...
cbar.ax.set_ylabel('FLACHL [mg/m3]', rotation=270, va='bottom')

plt.savefig('../figs/flachl_'+yini+'-'+yend+'.png',format='png',dpi=1000)
plt.show()
