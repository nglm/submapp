...
data = np.sqrt(np.square(u10)+np.square(v10))
...
plt.tight_layout()
fig.suptitle("GOTM 10m Wind Speed at BATS (12 hourly)", fontsize=12)
plt.subplots_adjust(top=0.95)

outfile='../figs/plot_surf_ws10_'+str(year_ini)+'-'+str(year_end)+'.png'
